...
public class ServerNameGenerator {
   ...
   public static String [] adj ={"Happy", "Beautiful", "Fast", "Tall", "Smart", "Delicious", "Funny", "Bright", "Brave", "Peaceful"};
   public static String [] noun = {"Dog","Cat","Car","Book","Tree","Chair","Computer","Flower","Sun","House",};
